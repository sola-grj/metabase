...
import CustomFormSetup from "metabase/components/form/CustomFormSetup";
import StandardFormSetup from "metabase/components/form/StandardFormSetup";
...
} from "metabase/components/form/CustomFormSetup";
...
const ReduxFormComponent = reduxForm()(props => {
  const FormComponent =
    props.formComponent || (props.children ? CustomFormSetup : StandardFormSetup);
