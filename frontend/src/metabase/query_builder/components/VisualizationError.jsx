  ...
  render() {
    ...
    if (error && typeof error.status === "number") {
      ...
      return (
        ...
        //   <div className="QueryError-image QueryError-image--queryError mr4" style={{float:"left"}}/>
        ...
        //   </div>
        // </div>
        <div className={cx(className, "QueryError2 flex justify-center")} style={{margin: "0 0 0 155px"}}>
          <div className="QueryError-image QueryError-image--queryError mr4" style={{margin: "-19px -159px 0 31px"}}/>
          <br/>
          <div className="QueryError2-details" style={{margin: "110px 151px 0 0"}}>
             <h1 className="text-bold">{t`There was a problem with your question`}</h1>
             {/*<p className="QueryError-messageText">{t`Most of the time this is caused by an invalid selection or bad input value. Double check your inputs and retry your query.`}</p>*/}
        <ErrorDetails className="pt2" details={error} />
      </div>
