...
console.log("new dashboard" + Urls.newDashboard());
...
const dashboardUrl = Urls.newDashboard();
      ...
      <nav className={"Nav AdminNav sm-py1"}>
        <div className="sm-pl4 flex align-center pr1">
          <div className="NavTitle flex align-center">
            ...
            <span className="NavItem-text ml1 hide sm-show text-bold" style={style}>{t`Metabase Admin`}</span>
          </div>
      ...
      >
        <Flex style={{ minWidth: 64}} align="center" justify="center">
          ...
          >
            <Flex
              // 自定义分析平台
              style={{ minWidth: 230, height: 33, }}
              // 税收调查数据
              // style={{ minWidth: 300, height: 33, }}
        ...
        <Flex ml="auto" align="center" pl={[1, 2]} className="relative z2">
          ...
          {/*    }}*/}
          {/*  >*/}
          {/*    <Icon size={14} p={"11px"} name="sql" tooltip={t`Write SQL`} />*/}
          {/*    <h4 className="hide md-show ml1 text-nowrap">{t`Extemporaneous inquiry`}</h4>*/}
          {/*  </Link>*/}
          {/*)}*/}
          ...
          {hasDataAccess && (
            ...
            >
              ...
              <h4 className="hide md-show ml1 text-nowrap">{t`Analysis results`}</h4>
            </Link>
          )}
          ...
          {hasDataAccess && (
            ...
            >
              ...
              <h4 className="hide md-show ml1 text-nowrap">{t`Create dashboard`}</h4>
            </Link>
          )}
          ...
          {hasDataAccess && (
            ...
            >
              ...
              <h4 className="hide md-show ml1 text-nowrap">{t`Create timer`}</h4>
            </Link>
          )}
