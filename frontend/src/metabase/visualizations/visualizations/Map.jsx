...
import CMap from "../components/ChoroplethMapTest"
...
// import { isSameSeries } from  "metabase/visualizations/lib/utils";                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ase/visualizations/lib/utils";
import {isSameSeries} from "metabase/visualizations/lib/utils";
import {GRAPH_DATA_SETTINGS} from "../lib/settings/MyGraph"
import {
  metricSetting,
  dimensionSetting,
  fieldSetting,
...
// 测试
// import App from './OwnTestMap'
// import CMap from "./QuanGuoTest";
export default class Map extends Component {
  ...
  static isSensible({ cols, rows }) {
    ...
    // );
    // console.log("map中得cols  " +cols[0].name)
    // rows中就是数据库中得每一条数据，但不包含key，只有value
    // console.log("map中得rows  " + rows)
    return (
      PinMap.isSensible({ cols, rows }) ||
      ChoroplethMap.isSensible({ cols, rows })
      // CMap.isSensible({ cols, rows })
    );
  }
  ...
  static settings = {
    ...
    "map.region": {
      ...
      getDefault: ([{ card, data }]) => {
        ...
        } else if (card.display.indexOf("云南") != -1) {
          return "云南"
        }
        return null;
      },
  ...
  render() {
    ...
    // settings["map.dimension"] = "adcode";
    console.log("map中的区域字段————" + settings["map.dimension"])
    // Map.settings["graph.dimensions"] = {
    //   ...Map.settings["graph.dimensions"],
    //   title: t`Y-axis`,
    // };
    // console.log("猜测graph.metrics——"+JSON.stringify(Map.settings["graph.metrics"].getProps()))
    // for (let i = 0; i < ; i++) {
    //
    // }
    if (PIN_MAP_TYPES.has(type)) {
      ...
      // 第一版测试地图
      return <CMap {...this.props} />;
      // 测试江西下钻地图
      // return <App1 {...this.props} />;
