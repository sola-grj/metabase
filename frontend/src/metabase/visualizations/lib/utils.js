...
export function getFriendlyName(column) {
  ...
  // console.log("column.display_name 名字——" + column.display_name)
...
export function getDefaultDimensionsAndMetrics(
  ...
  // row 是数据库中的每一条数据
  // console.log("列？" + data.cols)
  // console.log("列？" + data.rows)
  ...
  // console.log("测试是否是指标的值2" + metricColumns.name)
