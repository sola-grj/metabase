...
(defn format-personal-collection-name
  ...
  (tru "{0} {1}'的个人集合" last-name first-name))
  ;(tru "{0} {1}''s Personal Collection" last-name first-name))
  ;(tru "{0} {1}''s Personal Collection" "last-name" "first-name"))
...
(s/defn ^:private user->personal-collection-name :- su/NonBlankString
  ...
  ;(let [{first-name :last_name, last-name :first_name} (db/select-one ['User :first_name :last_name]
                                                         :id (u/get-id user-or-id))]
    (format-personal-collection-name first-name last-name)))
    ;(format-personal-collection-name  last-name first-name)))
